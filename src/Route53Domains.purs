...
checkDomainAvailability = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "checkDomainAvailability"
...
checkDomainTransferability = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "checkDomainTransferability"
...
deleteTagsForDomain = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "deleteTagsForDomain"
...
disableDomainAutoRenew = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "disableDomainAutoRenew"
...
disableDomainTransferLock = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "disableDomainTransferLock"
...
enableDomainAutoRenew = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "enableDomainAutoRenew"
...
enableDomainTransferLock = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "enableDomainTransferLock"
...
getContactReachabilityStatus = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "getContactReachabilityStatus"
...
getDomainDetail = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "getDomainDetail"
...
getDomainSuggestions = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "getDomainSuggestions"
...
getOperationDetail = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "getOperationDetail"
...
listOperations = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "listOperations"
...
listTagsForDomain = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "listTagsForDomain"
...
renewDomain = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "renewDomain"
...
resendContactReachabilityEmail = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "resendContactReachabilityEmail"
...
retrieveDomainAuthCode = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "retrieveDomainAuthCode"
...
transferDomain = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "transferDomain"
...
updateDomainContact = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "updateDomainContact"
...
updateDomainContactPrivacy = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "updateDomainContactPrivacy"
...
updateDomainNameservers = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "updateDomainNameservers"
...
updateTagsForDomain = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "updateTagsForDomain"
...
viewBilling = Request.request service method  where
    service = Request.ServiceName "Route53Domains"
    method = Request.MethodName "viewBilling"
